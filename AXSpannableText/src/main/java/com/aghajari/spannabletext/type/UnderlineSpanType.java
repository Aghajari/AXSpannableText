...
import com.aghajari.spannabletext.span.AXUnderlineSpan;
 ...
 */
public class UnderlineSpanType extends AXSpannableStyleType {

    public final static Pattern STRIKE_THROUGH_PATTERN =
            Pattern.compile("\\+{2}(\\s*[^~\\s][^~]*)\\+{2}");

    public UnderlineSpanType() {
        setClickable(false);
    ...
    protected Object createSpan(AXSpanRange range) {
        return new AXUnderlineSpan(this,range);
    }
